...
@section('content')
    <x-site-container class="max-w-6xl py-12 sm:py-16">
        <header class="max-w-2xl">
            <h1 class="font-display text-4xl text-stone-900">Arama</h1>
        ...
        <form method="GET" action="{{ route('search') }}" class="mt-8 max-w-xl" role="search">
            ...
            <div class="flex gap-2">
                ...
                >
                <button type="submit" class="shrink-0 border border-stone-900 bg-stone-900 px-5 py-3 text-sm font-medium uppercase tracking-widest text-white hover:bg-stone-800 focus:outline-none focus:ring-2 focus:ring-accent-600 focus:ring-offset-2">
                    Ara
                </button>
            </div>
        </form>
